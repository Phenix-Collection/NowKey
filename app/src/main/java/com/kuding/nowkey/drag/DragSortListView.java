package com.kuding.nowkey.drag;
...
public class DragSortListView extends ListView {
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        funcStr = context.getResources().getString(R.string.now_key_shortcut_settings_title);
...
//            mFloatAlpha = a.getFloat(R.styleable.DragSortListView_float_alpha, mFloatAlpha);
    ...
    public void removeItem(int which) {
        ...
        if (TextUtils.equals(funcText.getText().toString().trim(), funcStr) && isShowRemoveFuncDialog) {
            if (mRemoveListener != null) {
                mRemoveListener.remove(which, true);
                isShowRemoveFuncDialog = false;
            }
        } else {
            if (!TextUtils.isEmpty(funcTextStr)) {
                if (mRemoveListener != null) {
                    if (mRemoveListener.isRemoveLast(which)) return;
                }
