...
package com.kuding.nowkey.functions.screenshot;
...
//        SystemUI.overrideNotificationAppName(context, mNotificationBuilder);
        ...
        mNotificationManager.notify(GlobalScreenshot.SCREENSHOT_NOTIF_ID, mNotificationBuilder.build());
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Notification.Action.Builder shareActionBuilder = new Notification.Action.Builder(
                    ...
                    r.getString(R.string.share), shareAction);
            ...
            Notification.Action.Builder deleteActionBuilder = new Notification.Action.Builder(
                    ...
                    r.getString(R.string.delete), deleteAction);
    ...
    protected void onCancelled(Void params) {
        ...
        mNotificationManager.cancel(GlobalScreenshot.SCREENSHOT_NOTIF_ID);
    }
}
...
class GlobalScreenshot {
    ...
    public static int SCREENSHOT_NOTIF_ID = R.layout.global_screenshot;
...
//            Log.d("saveScreenshotInWorkerThread", "The image is null before saving it!");
    ...
    void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible,
        ...
        // Take the screenshot
        mScreenBitmap = ((NowKeyApplication) mContext).getmScreenCaptureBitmap();
...
//        SystemUI.overrideNotificationAppName(context, b);
        ...
        Notification n = new Notification.BigTextStyle(b)
                .bigText(errorMsg)
                .build();
        nManager.notify(GlobalScreenshot.SCREENSHOT_NOTIF_ID, n);
    }
    ...
    public static class TargetChosenReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final NotificationManager nm =
                    (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
            nm.cancel(GlobalScreenshot.SCREENSHOT_NOTIF_ID);
        }
    }
