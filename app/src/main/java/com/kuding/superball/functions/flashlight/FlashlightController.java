...
package com.kuding.superball.functions.flashlight;
...
public class FlashlightController {
    ...
    private static FlashlightController sInstance;

    private FlashlightController(Context mContext) {
    ...
    public static FlashlightController getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new FlashlightController(context);
        }
        return sInstance;
    }
